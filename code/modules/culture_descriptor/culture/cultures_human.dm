...
/decl/cultural_info/culture/human/deepcore
	name = CULTURE_HUMAN_DEEPCORE
	description = "You are from the Deep Core, a region that is pretty dificult to travel with hyperdrive within this sector. Raised in one of the many deep core worlds. Most of the population \
	are known as being mildly wealthy and connected to many goods, the largest species group in the Deep Core would be Humanity. Most inhabitants have had a decent upbringing and represent the \
	a great level of comfort expected in the galaxy. Most Deep Core worlders are like many across the galaxy, though a few harbour rivalries with non-human cultures \
	groups are generally overly proud of their heritage of being born the most industrialized sector of the galaxy, to the point that they constantly refer to it."
	economic_power = 1

/decl/cultural_info/culture/human/huttspace
	name = CULTURE_HUMAN_HUTTSPACE
	description = "You are from Hutt Space. Raised on one of the planets ran by the Hutt Cartel. Most of the population \
	are known as being extremely poor and looking for opportunities to get rich quick , Hutt Space is under control by the Hutt Cartel, a Syndicate of Hutts who run the sector by themselves \
	the most populous planet in Hutt Space would be Nal-Hutta the Capital world. Hutt space is connected with many hyperspace routes leading it to be very influencial on the galaxy, there are many slaves and spacers who reside here for labour \
	many inhabitants of this sector are either stuck here or are trying to get a better line of work with the Hutts."
	economic_power = 0.85
