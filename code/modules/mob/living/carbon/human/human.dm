...
GLOBAL_LIST_INIT(dream_tokens, list(
	"Bespin", "Coruscant", "Naboo", "Nal Hutta","Ryloth", "Tatooine", "Alderaan", "an ithorian", "a near human", "an Umbaran", "blood", "deep space", "the galactic news", "frak",
	"an Imperial Star Destroyer", "an old friend", "Nar Shaddaa", "a criminal", "the governor", "a miraluka", "a zeltron", "a herglic", "a doctor", "hyperspace", "beskar",
	"a smuggler", "a jedi", "a nerf herder", "a blade of light", "a forgotten tomb", "Mandalore", "the empire", "a gungan", "a hutt", "a catastrophe", "a field of flowers",
	"the hutts", "a human", "a bothan", "a grey uniform", "an ancient artifact", "bacta", "kolto", "a rancor", "a gran", "a mercenary", "a Ssi-ruu", "a voice", "a distress call",
	"the consortium", "a senator", "a great disturbence", "a wound in the force", "your skin crawls", "a feeling of hatred", "a feeling of loss", "flames", "credits",
	"a mutant", "a spacer", "a feeling of peace", "a great war", "a feeling of apathy", "a fallen pupil", "a freighter", "a starfighter", "Corellia", "a nautolan", "the sith",
	"a glass of bluemilk", "an angry wookie", "a zabrak", "a wookie in battle", "a broken droid", "a protocal droid", "a master", "an apprentice", "moisture", "Kamino", "aurebesh text",
	"Kessel", "a feeling of sorrow", "a strange moon", "a moon", "a droid army", "an Exogorth", "a Mynock swarm", "a corpse", "a new beginning", "homesick", "a cantina band",
	"an odd looking asteroid", "a Mandalorian", "a warrior", "a hermit", "the clone army", "a bad feeling", "a battle over", "a sinister plot", "a family", "a bith", "an ally",
	"an assassin droid", "a battledroid", "a thick gray ooze", "a stranger", "deathsticks", "a deal", "a datapad", "a hologram recording", "a bountyhunter", "a failure", "twin sun horizon",
	"a fallen knight", "glowing yellow eyes in the dark", "the ancient jedi temple", "Korriban", "Tyhthon", "whispers all around you", "a brother", "a sister", "an ancient civilization",
	"Felucia", "a eerie feeling", "an astromech", "a Mon Calamari vessel", "a basilisk war droid", "a droideka", "a twilek", "a prisoner in the maw", "an horrifying entity beyond understanding",
	"a tall and gaunt humaniod with white hair and luminescing eyes", "a bantha", "a nerf", "a cantina", "a massive battle in the upper atmosphere", "a temple on Yavin IV", "a diplomatic shuttle",
	"an unknown sector", "a chiss", "a vibroblade", "a cave of crystals", "a pile of credits", "beautiful memories", "an ocean", "behind you", "a spice run", "a success", "a strange beaker of liquid",
	"the old republic", "a place forgotten", "someone near by", "a stowaway", "warmth", "space", "riches", "a storm-surgeon", "a fall", "the rebellion", "the order",
))
