...
/// Star Wars Factions W.I.P//////

#define FACTION_GALACTIC_EMPIRE    "Galactic Empire"
#define FACTION_CONFEDERACY        "Confederacy of Independant Systems Remnants"
#define FACTION_HUTT_CARTEL        "Hutt Cartel"
...
#define CULTURE_HUMAN_DEEPCORE  "Deep Core Worlder"
#define CULTURE_HUMAN_HUTTSPACE  "Hutt Space Worlder"
